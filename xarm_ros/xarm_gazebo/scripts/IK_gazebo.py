...
pub = rospy.Publisher('/xarm/xarm7_traj_controller/command', JointTrajectory, queue_size=10)
...
urdf_path = os.path.join(script_dir, "../../xarm_description/urdf/xarm7.urdf")
...
# End-effector frame
end_effector_frame = model.getFrameId("link7")  # Replace with your end-effector frame name
